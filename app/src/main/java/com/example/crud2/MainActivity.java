...
public class MainActivity extends AppCompatActivity {
    ...
    public void RefreshList() {
        ...
        cursor = db.rawQuery("SELECT * FROM crud", null);
        daftar = new String[cursor.getCount()];
        cursor.moveToFirst(); //posisi pointer kursor pada record pertama
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item){
                            ...
                            case 2:
                                ...
                                db.execSQL("DELETE FROM crud WHERE ruangan = '"+selection+"'");
                                RefreshList();
                                break;
                        }
                    }
